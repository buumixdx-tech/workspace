...
def process_vc_deposit(session, vc_id):
    ...
    is_deposit_cleared = (dep_due is not None and dep_due <= EPSILON) or (actual_net_deposit >= (dep_due - EPSILON) if dep_due is not None and dep_due > EPSILON else False)
