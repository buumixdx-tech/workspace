...
学 Baostock 的约定：先查 CWD，再查项目根目录。
便捷变量直接导出，调用方 `from src.config_loader import SERVER_HOST`。
"""
...
# [ui]
UI_REFRESH_SECONDS: int = int(_CFG["ui"]["refresh_seconds"])
UI_DEFAULT_CODE: str = _CFG["ui"]["default_code"]
